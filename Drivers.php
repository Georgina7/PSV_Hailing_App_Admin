				...
				<div class="form-group">
					<div class="grid grid-cols-6 gap-6 p-4">
						<!-- <div class="col-span-6 sm:col-span-3">
			                ...
			                <input type="text" name="driver_edit_name" id="driver_edit_name" placeholder="John Doe " class="block w-full p-2 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
			            </div>
						<div class="col-span-6 sm:col-span-3">
			                <label for="phone_number" class="block text-sm font-medium text-gray-700">Phone Number</label>
			                <input type="text" name="driver_edit_phone_number"  id="driver_edit_phone_number"   placeholder="0712345678" class="block w-full p-2 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
			            </div>
						<div class="col-span-6 sm:col-span-3">
			                <label for="email" class="block text-sm font-medium text-gray-700">Email</label>
			                <input type="email" name="driver_edit_email" id="driver_edit_email"  placeholder="johndoe@example.com" class="block w-full p-2 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
			            </div>	 -->
						<div class="col-span-6 sm:col-span-3">
							...
							foreach($fetchDriverData as $key => $value)
							{
								...
								if($value['status']== "enabled"){
					              ...
					              <td class="px-6 py-4 text-sm font-medium text-right whitespace-nowrap">
					                <button onclick="driverEditModal('<?php echo $key; ?>')" class="px-3 py-1 text-gray-800 bg-blue-100 rounded hover:underline">Edit</button>
