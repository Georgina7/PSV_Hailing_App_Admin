			...
			<div class="m-2">
				<table class="min-w-full divide-y divide-gray-200 box-border">
			          ...
			          <?php
						...
						if($fetchTripData > 0){
							$count = 1;
							foreach($fetchTripData as $trip){
								$ref_table = 'Users/'.$trip['pwdID'];
								$fetchPWDDetails = $database->getReference($ref_table)->getValue();
							?><tr>
				              ...
				              <td class="px-6 py-4 whitespace-nowrap">
				                <div class="text-sm text-gray-900 driver_name"><?php echo $trip['date'] .", ".$trip['time']; ?></div>
				              </td>
				              <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 driver_licence"><?php echo $trip['source']." - ".$trip['destination']; ?></td>
				              <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 driver_phone_number"><?php echo $fetchPWDDetails['fullName']; ?></td>
				              <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 driver_phone_number">Shem Nzamba</td>
				              <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 driver_phone_number"><?php echo $trip['status']; ?></td>				              
