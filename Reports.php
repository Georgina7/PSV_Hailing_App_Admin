...
<div class="flex flex-wrap">
                    ...
                    <div class="p-5 border-b-4 border-green-600 rounded-lg shadow-xl bg-gradient-to-b from-green-200 to-green-100">
                        <div class="flex flex-row items-center">
                            <div class="flex-shrink pr-4">
                                <div class="p-5 bg-green-600 rounded-full"><i class="fas fa-users fa-2x fa-inverse"></i></div>
                            </div>
                            <div class="flex-1 text-right md:text-center">
                                <h5 class="font-bold text-gray-600 uppercase">Total Users</h5>
                                 <?php
                                    $user_ref = 'Users';
                                    $total_users = $database->getReference($user_ref)->getSnapshot()->numChildren();
                                ?>
                                <h3 class="text-3xl font-bold"><?php echo $total_users; ?> <span class="mr-4 text-green-500"><i class="fas fa-exchange-alt"></i></span></h3>
                            </div>
                        </div>
                    </div>
                    <!--/Metric Card-->
                ...
                <div class="w-full p-6 md:w-1/2 xl:w-1/3">
                    ...
                    <div class="p-5 border-b-4 border-blue-500 rounded-lg shadow-xl bg-gradient-to-b from-blue-200 to-blue-100">
                        <div class="flex flex-row items-center">
                            <div class="flex-shrink pr-4">
                                <div class="p-5 bg-blue-600 rounded-full"><i class="fas fa-users fa-2x fa-inverse"></i></div>
                            </div>
                            <div class="flex-1 text-right md:text-center">
                                <h5 class="font-bold text-gray-600 uppercase">Total Drivers</h5>
                                <?php
                                    $drivers_ref = 'Drivers';
                                    $total_drivers = $database->getReference($drivers_ref)->getSnapshot()->numChildren();
                                ?>
                                <h3 class="text-3xl font-bold"><?php echo $total_drivers; ?> <span class="mr-4 text-blue-500"><i class="fas fa-exchange-alt"></i></span></h3>
                            </div>
                        </div>
                    </div>
                    <!--/Metric Card-->
                ...
                <div class="w-full p-6 md:w-1/2 xl:w-1/3">
                    ...
                    <div class="p-5 border-b-4 border-pink-500 rounded-lg shadow-xl bg-gradient-to-b from-pink-200 to-pink-100">
                        <div class="flex flex-row items-center">
                            ...
                            <div class="flex-1 text-right md:text-center">
                                <h5 class="font-bold text-gray-600 uppercase">Total Admins</h5>
                                <?php
                                    $admins_ref = 'Admins';
                                    $total_admins = $database->getReference($admins_ref)->getSnapshot()->numChildren();
                                ?>
                                <h3 class="text-3xl font-bold"><?php echo $total_admins; ?>  <span class="mr-4 text-blue-500"><i class="fas fa-exchange-alt"></i></span></h3>
                            </div>
                        </div>
                    </div>
                    <!--/Metric Card-->
